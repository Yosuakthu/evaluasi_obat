<?php
  ...
  include("layout/sidebar.php");
    ...
    INNER JOIN obat ON expire.id_obat = obat.id_obat GROUP BY keluar.id_masuk ORDER BY COUNT(keluar.id_masuk) ASC LIMIT 5 ");
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Obat Kurang Digunakan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
